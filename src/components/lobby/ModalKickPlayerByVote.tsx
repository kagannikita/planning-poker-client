...
const ModalKickPlayerByDealer: FC<ModalKickPlayerByDealerProps> = ({ kickMemberHandler, playerId, kickerName, kickedName }) => {
	...
	return (
		...
		>
			...
			<Modal.Content>
				<p>{kickerName} want to kick member {kickedName}. Do you agree with it? </p>
			</Modal.Content>
			<Modal.Actions>
